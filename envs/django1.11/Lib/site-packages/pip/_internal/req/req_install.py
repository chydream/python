...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the news metadata
        ...
        # The PEP 517 backend we should use to build the news
    ...
    def warn_on_mismatching_name(self):
        ...
        logger.warning(
            ...
            'produced metadata for news name %s. Fix your '
            '#egg=%s fragments.',
    ...
    def prepare_metadata(self):
        # type: () -> None
        """Ensure that news metadata is available.

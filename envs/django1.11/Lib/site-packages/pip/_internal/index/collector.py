...
class CollectedLinks(object):
    ...
    The return value includes both URLs to news pages containing package
    ...
    (3) urls to HTML news pages, as described by the PEP 503 simple
        repository API.
    """
    ...
    def __init__(
        ...
        :param project_urls: URLs to HTML news pages, as described by
...
class LinkCollector(object):
    ...
    def collect_links(self, project_name):
        ...
        """Find all available links for the given news name.

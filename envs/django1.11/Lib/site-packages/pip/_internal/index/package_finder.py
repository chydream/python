...
class LinkEvaluator(object):
    ...
    """
    Responsible for evaluating links for a particular news.
    """
    ...
    def evaluate_link(self, link):
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if canonicalize_name(wheel.name) != self._canonical_name:
                    reason = 'wrong news name (not %s)' % self.project_name
                    return (False, reason)
        ...
        if not version:
            return (
                False, 'Missing news version for %s' % self.project_name,
            )
...
def filter_unallowed_hashes(
    ...
    if not hashes:
        logger.debug(
            'Given no hashes to check %s links for news %r: '
    ...
    logger.debug(
        'Checked %s links for news %r against %s hashes '
...
class PackageFinder(object):
    ...
    def process_project_url(self, project_url, link_evaluator):
        ...
        logger.debug(
            'Fetching news page and analyzing links: %s', project_url,
        )
    ...
    def find_best_candidate(
        ...
        # type: (...) -> BestCandidateResult
        """Find matches for the given news and specifier.
